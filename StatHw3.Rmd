...
Overall, the order of the OOB error from the lowest to the highest is the single tree, random forest, and bagging. Likewise, the order of the cost of FP and FN from the lowest to the highest is the single tree, random forest, and bagging. Although these result indicate that the single classification tree predicts the variable "vehicleSearch" most accurately, a single decision tree has is more disadvantageous than bagging and random forest in terms of variance.
