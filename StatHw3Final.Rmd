...
Thus, the OOB error for this single classification tree is approximately `r oob_tree1`%. Next, calculate the cost of FP and FN for this tree.
...
## 3.3 (3b) Comparison of variable importance
...
## 3.4 (3c) Tradeoff between efficacy and interpretability
